...
ClientHandler::ClientHandler()
{
    ...
    try
    {
        ...
        nn_bind(ClientHandler::ReplySock, "tcp://192.168.100.222:8003");// (char*) ("tcp://"+  _GlobalDefs.ConnectionIP +":8003").c_str());
    }
    catch(int e)
    {
    ...
    try
    {
        ...
        nn_bind(ClientHandler::PubSock,"tcp://192.168.100.222:8002");
    }
    catch(int e)
    {
		...
		while (getline(myfile, line))
		{
			...
			else
			{
              ...
              obj.InstrumentName= row[j++];
				...
				//cimlist.push_back(obj);
				cimlist[obj.Token]= obj;
				//_Contractqueue.FillCim(obj);
				if(obj.Token==45449)
				{
				cout<<"breakc ontract file"<<endl;
				}
			}
			cnt++;
			line = "";
